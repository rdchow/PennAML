...
open ($fh,"<mutual-exclusivity-table.REL1.tsv") || die "c";
open ($ofh,">mutual-exclusivity-table.REL1.2.tsv") || die "c";
my $head2 = <$fh>;
print $ofh $head2;
my %hash2;
while (<$fh>){
...
# add any gene pairs that were covered in the "diagnosis" section but not in "relapse"
